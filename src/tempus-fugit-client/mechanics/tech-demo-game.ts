...
export class TechDemoGame extends Mission {
    ...
    constructor() {
        ...
        let c2:Card = new Card(this,"test2", "","card2", "!#G(a&!b)", 2, false, 3, 1, "Magic Stand","this.stand.spawn(enemy);");
        let c3:Card = new Card(this,"test3", "","card3", "#Oa&(d|!b)", 2, true, 0, 0, "","enemy.takeHit(this.getAttackPower());");
        let c4:Card = new Card(this,"test4", "","card4", "OEc", 2, false, 0,0 , "","enemy.takeHit(this.getAttackPower());");
