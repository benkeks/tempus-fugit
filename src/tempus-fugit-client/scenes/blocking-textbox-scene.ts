...
export class BTextbox {
     ...
     * @param dialog 
     */
    public addStoryDialog(dialog: StoryDialog, blocking: boolean = true) {
    ...
    private playNextStoryDialog() {
        ...
        // position of box
        let x = GameInfo.width / 2 - this.boxWidth / 2;
        let y = 850;
        this.mission._active = false;

        // make card on handgui invisible
        for (let cardGUI of this.handGUI.cardGUIs) {
