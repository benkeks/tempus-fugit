...
export class MainScene extends Phaser.Scene implements GameStateListener {
    ...
    create(): void {
        // example textbox
        let content = ["You're walking deeper into the woods... What is it with these slimes?",
            "Onwards you hear a misterious sound. It seems like someone is following you.",
            "More goblins seem to come your way, the ground is somewhat... shaking?",
            "The shaking becomes stronger and stronger, something nasty is coming your way. Be careful!"];
