...
export class PlayerGUI extends Phaser.GameObjects.Sprite implements PlayerListener {
    ...
    constructor(
        ...
        this.baseAttackText = this.scene.add.text(this.x + 100, this.y + 320, player.baseAttack.toString()).setStyle(textStyle).setOrigin(0.5,0);
        this.sword = this.scene.add.sprite(this.x - 15, this.y + 340, "swordFont").setScale(0.4);
        this.sword.setScale(2, 2);
        this.hpText = this.scene.add.text(this.x + 100, this.y + 390, player.getHP().toString()).setStyle(textStyle).setOrigin(0.5,0);
        this.heart = this.scene.add.sprite(this.x - 15, this.y + 410, "heartFont").setScale(0.4);
