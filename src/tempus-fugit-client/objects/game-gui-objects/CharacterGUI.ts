 ...
 * @author Mustafa
 */
export class CharacterGUI extends Phaser.GameObjects.Container implements EnemyListener{
    ...
    public setHP(hp:number):void {
        ...
        this.baseAttackText.setPosition(this.hpText.width + CharacterGUI.TEXT_PADDING, this.baseAttackText.y);
        this.centerSprite();
    }
    /**
